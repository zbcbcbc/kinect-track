...
int main(int, char **)
{
	...
	//Find x,y from the rectangle
		...
		prevPts=contours[maxContour];
	    	...
	    	//calcOpticalFlowPyrLK(image_prev,image_next,prevPts,nextPts,status,err,winSize,maxLevel,criteria,derivLambda,flags);		
		image_prev=image_next.clone();
	    }
            ...
            rectangle(image_next, r, Scalar(0, 255, 0), 2);
            r.x -= 10;
            r.y -= 20;
